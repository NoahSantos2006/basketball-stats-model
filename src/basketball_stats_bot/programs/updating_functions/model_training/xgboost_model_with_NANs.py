...
def train_xgboost_with_nan_model(conn):
    ...
    def train_model(conn, prop):
        ...
        joblib.dump(final_model, fr"C:\Users\noahs\.vscode\basketball stats bot\main\training\models\XGBoost\{prop}_xgboost_model_with_NANs.pkl")
    ...
    for prop in props:
        ...
        print(f"Training XGBoost model with NAN for {prop}..")
...
if __name__ == "__main__":
    ...
    train_xgboost_with_nan_model(con)