...
def train_v11_model(conn):
    ...
    def train_model(conn, prop):
        ...
        scoringv11_path = os.path.join(config.XGBOOST_PATH, 'scoringv11')

        if not os.path.isdir(scoringv11_path):

            os.mkdir(scoringv11_path)

        curr_path = os.path.join(config.XGBOOST_PATH, "scoringv11", f"{prop}_xgboost_model_scoring_v11.pkl")
...
def train_v12_model(conn):
    ...
    def train_model(conn, prop):
        ...
        scoringv12_path = os.path.join(config.XGBOOST_PATH, 'scoringv12')

        if not os.path.isdir(scoringv12_path):

            os.mkdir(scoringv12_path)

        curr_path = os.path.join(config.XGBOOST_PATH, "scoringv12", f"{prop}_xgboost_model_scoring_v12.pkl")
...
def train_v14_model(conn):
    ...
    def train_model(conn, prop):
        ...
        scoringv14_path = os.path.join(config.XGBOOST_PATH, 'scoringv14')

        if not os.path.isdir(scoringv14_path):

            os.mkdir(scoringv14_path)

        curr_path = os.path.join(config.XGBOOST_PATH, "scoringv14", f"{prop}_xgboost_model_scoring_v14.pkl")
    ...
    for prop in props:
        ...
        print(f"Training XGBoost Model V14 for {prop}..")
        train_model(conn, prop)
